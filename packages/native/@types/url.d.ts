...
export declare const getHashedPath: (url: URL | string) => string;
/** Returns the actual hash without the hashtag */
export declare const getHash: (url: URL | string) => string;
/** Removes the hash from the full URL for a clean URL string */
export declare const clean: (url: URL | string) => string;
