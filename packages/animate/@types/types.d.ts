...
import type { EASINGS } from "./animate";
/**
 ...
 * - "error" - fired when an error has occured in setting up the animation (e.g. invalid options, invalid target, browser doesn't support certain features, etc.)
 ...
 * @returns T
*/
export declare type TypeComputableAnimationFunction<T> = (index?: number, total?: number, element?: HTMLElement) => T;
/**
 * The callback parameters for computable animation functions
 * e.g. `(index?: number, total?: number, element?: HTMLElement) => number`
 */
export declare type TypeCallbackArgs = Parameters<TypeComputableAnimationFunction<(string & {})[]>>;
/**
 ...
 */
export declare type TypeCommonGenerics = number | (string & {}) | `var(--${string})` | `var(--${string}, ${string | number})`;
/**
 ...
 * check out [github.com/microsoft/TypeScript/issues/29729](https://github.com/microsoft/TypeScript/issues/29729) to learn more
 */
export declare type TypeCommonCSSGenerics = TypeCommonGenerics | `var(--${string})` | `var(--${string}, ${string | number})`;
/**
 * The CSS Generics of Property Indexed Keyframes {@link PropertyIndexedKeyframes}
 */
export declare type TypeCSSGenericPropertyKeyframes = TypeCommonGenerics | TypeCommonGenerics[];
/**
...
*/
export declare type TypeComputableCSSGenerics = TypeCSSGenericPropertyKeyframes | TypeComputableAnimationFunction<TypeCSSGenericPropertyKeyframes>;
/**
 ...
 *
*/
export declare type TypeCSSProperties = Properties<TypeCommonGenerics, TypeCommonGenerics> & PropertiesHyphen<TypeCommonGenerics, TypeCommonGenerics> & PropertiesFallback<TypeCommonGenerics, TypeCommonGenerics> & PropertiesHyphenFallback<TypeCommonGenerics, TypeCommonGenerics> & IIndividualTransformProperties & KebabCasedProperties<IIndividualTransformProperties>;
/**
 ...
 */
declare type TypeComputableCSSProperties = {
 ...
 */
declare type TypeComputableAnimationConfig = {
    [key in keyof IStandaloneAnimationConfig]?: IStandaloneAnimationConfig[key] | TypeComputableAnimationFunction<IStandaloneAnimationConfig[key]>;
} & {
    [key in keyof IStandaloneAnimationOptions]?: IStandaloneAnimationOptions[key] | TypeComputableAnimationFunction<IStandaloneAnimationOptions[key]>;
};
/**
 ...
 */
declare type MergedType = Omit<IComputableCSSProperties, keyof IAnimationConfig | "offset"> & IAnimationConfig;
/**
